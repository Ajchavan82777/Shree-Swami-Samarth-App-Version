...
const SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'default_gst_type',  label: 'Default GST Type',          type: 'text',  hint: 'sgst_cgst / igst / vat / none' },
      { key: 'cgst_rate',         label: 'Default CGST Rate (%)',      type: 'text',  hint: 'e.g. 9  (half of 18% total)' },
      { key: 'sgst_rate',         label: 'Default SGST Rate (%)',      type: 'text',  hint: 'e.g. 9  (half of 18% total)' },
      { key: 'igst_rate',         label: 'Default IGST Rate (%)',      type: 'text',  hint: 'e.g. 18 (inter-state)' },
      { key: 'vat_rate',          label: 'Default VAT Rate (%)',       type: 'text',  hint: 'e.g. 12' },
      { key: 'tax_rate',          label: 'Fallback Tax Rate (%)',      type: 'text',  hint: 'Used when no specific rate is set — e.g. 18' },
    ]
  },
  {
